...
Je doel:
Je doel:
Voeg aan je bestaande $mijnauto object een nieuwe eigenschap Prijs toe met waarde 75000.
Overschrijf daarna de Kleur van 'Zwart' naar 'Rood' via dot notation.
Toon tenslotte het volledige object $mijnauto om te controleren of beide wijzigingen zijn doorgevoerd.
#>
